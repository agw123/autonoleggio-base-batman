			...
			if(flag == 1) {
				...
				switch (sceltaMenu) {
					...
					case 2:
						...
						break;
					case 3:
						System.out.println("Inserisci l'identificativo dell'auto da noleggiare (numero intero): ");
						idAuto = scan.nextInt();
						scan.nextLine();
				...
				switch (sceltaMenu) {
					case 1:
						System.out.println("Inserisci l'identificativo dell'auto (numero intero): ");
						idAuto = scan.nextInt();
						scan.nextLine();
						System.out.println("Inserisci la marca e il modello dell'auto: ");
						nomeAuto = scan.nextLine();
					...
					case 4:
						...
						break;
					case 5:
						System.out.println("Inserisci l'identificativo dell'auto riconsegnata (numero intero): ");
						idAuto = scan.nextInt();
						scan.nextLine();
				...
				switch (sceltaMenu) {
					case 1:
						System.out.println("Inserisci l'identificativo del mezzo (numero intero): ");
						idAuto = scan.nextInt();
						scan.nextLine();
					...
					case 3:
						...
						break;
					case 4:
						System.out.println("Inserisci l'identificativo del mezzo da usare (numero intero): ");
						idAuto = scan.nextInt();
						scan.nextLine();
